...
public function adminindex(MemberBulananChart $MemberBulananChart, PembacaBulananChart $PembacaBulananChart, MemberCountChart $MemberCountChart, TotalLoanChart $TotalLoanChart, TotalMemberChart $TotalMemberChart)
{
    $results = DB::table('books_loans')
    ->join('books', 'books_loans.book_id', '=', 'books.id')
    ->join('book_category', 'books.category_id', '=', 'book_category.id')
    ...
    return view('admin.literasi', compact('MemberBulananChart', 'PembacaBulananChart', 'categoryName', 'categoryName2', 'categoryName3' ,'result', 'MemberCountChart', 'TotalLoan', 'TotalLoanChart', 'firstBookName', 'secondBookName', 'thirdBookName', 'TotalMemberChart'));
}
}
